  ...
  <div class="bg-white">
    <header>
      <Popover class="relative bg-white">
        <div
          class="flex items-center justify-between px-4 py-5 mx-auto max-w-7xl sm:px-6 md:justify-start md:space-x-10 lg:px-8"
        >
      ...
      <div class="bg-white">
        ...
        >
          ...
          >
            ...
            <span
              class="block pb-1 -mb-1 text-transparent bg-gradient-to-r from-purple-600 to-indigo-600 bg-clip-text"
